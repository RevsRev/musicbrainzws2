...
import github.com.rev.fm.last.musicbrainz.coverart.CoverArtType;
...
public class ProxiedCoverArtImageBeanDecoratorTest {
  ...
  private CoverArtImageBean.CoverArtImageThumbnailsBean thumbnailsBean;
  ...
  public void initialise() {
    List<String> types = List.of("Front", "Back", "Medium");

    thumbnailsBean = new CoverArtImageBean.CoverArtImageThumbnailsBean();
