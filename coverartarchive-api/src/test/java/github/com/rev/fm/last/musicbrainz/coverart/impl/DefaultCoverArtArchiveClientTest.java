...
import github.com.rev.fm.last.musicbrainz.coverart.CoverArtException;
...
public class DefaultCoverArtArchiveClientTest {
  ...
  public void customClient() throws Exception {
    ...
    when(customHttpClient.execute(any(HttpUriRequest.class), any(HttpClientResponseHandler.class))).thenThrow(new IOException());
