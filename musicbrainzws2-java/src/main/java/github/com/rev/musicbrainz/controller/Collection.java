...
import github.com.rev.musicbrainz.query.search.CollectionSearchWs2;
import github.com.rev.musicbrainz.query.submission.CollectionReleasesHandlerWs2;
...
public class Collection extends Controller {
    ...
    public List<CollectionResultWs2> search() throws Exception {
