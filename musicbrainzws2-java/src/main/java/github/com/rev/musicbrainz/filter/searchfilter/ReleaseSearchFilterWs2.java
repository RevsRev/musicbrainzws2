package github.com.rev.musicbrainz.filter.searchfilter;
...
public class ReleaseSearchFilterWs2 extends SearchFilterWs2 {
    ...
    /* (non-Javadoc)
     * @see github.com.rev.musicbrainz.webservice.Filter()
     */
    ...
    /* (non-Javadoc)
     * @see github.com.rev.musicbrainz.webservice.Filter#createParameters()
     */
    @Override
