...
import github.com.rev.musicbrainz.controller.Disc;
import github.com.rev.musicbrainz.model.DiscTrackWs2;
...
public class DiscWs2 extends EntityWs2 {
    ...
    private static final Logger log = Logger.getLogger(DiscWs2.class.getName());
    /**
    ...
    public boolean equals(Object object) {
        if (!(object instanceof DiscWs2 other)) {
            return false;
        }
        if (this.discId == null) {
            return false;
        ...
        return this.discId.equals(other.getDiscId());
    }
}
