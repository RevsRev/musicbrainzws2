...
import github.com.rev.discid.DiscIdException;
import github.com.rev.discid.DiscInfo;
...
import github.com.rev.musicbrainz.webservice.ResourceNotFoundException;
   ...
   public Disc(){
    ...
    private DiscWs2 readFromDisk(String drive) throws MBWS2Exception {
        ...
        try {
            ...
            for (DiscInfo.TrackInfo t : discInfo.trackList)
            {
