package github.com.rev.musicbrainz.utils;
...
public class MbUtils {
    ...
    public static String extractUuid(String uriStr, String resType) {
        ...
        if (!"http".equals(uri.getScheme()) || !"musicbrainz.org".equals(uri.getHost())) {
            throw new IllegalArgumentException(uri + " is no MB ID");
        }

        String regex =
                "^/(label|artist|release-group|release|recording|work|collection|area|place|instrument|series)/([^/]*)$";
